...
**2.Relevance by Ghost Variables**
...
```{r}
# I was having problems with the "relev.ghost.var" function when using the "range" package to fit the random forest. I have changed to the "randomForest" library and then it works. The model should be the same as the one fitted before since we set a seed and specify the same number of trees.
